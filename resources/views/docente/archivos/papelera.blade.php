...
@section('page-title', 'Papelera de Reciclaje')
@section('breadcrumb', 'Docente / Mis Documentos / Papelera')

@section('topbar-actions')
    <a href="{{ route('docente.archivos.index') }}" class="btn btn-ghost btn-sm">
...
<div class="card">
    <div class="card-header bg-slate-800/50">
        <span class="card-title text-slate-300">🗑️ Archivos Eliminados</span>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex items-center justify-center gap-2">
                            <form action="{{ route('docente.archivos.restaurar', $archivo->id) }}" method="POST" class="inline">
                                @csrf
                            ...
                            <button type="button"
                                    ...
                                    onclick="openModal(
                                        '{{ route('docente.archivos.forzarEliminacion', $archivo->id) }}',
                                        'Estás a punto de eliminar DEFINITIVAMENTE el archivo &quot;{{ addslashes($archivo->nombre_original) }}&quot;. Esta acción no se puede deshacer y el archivo se perderá para siempre.'
                                    )">
                                <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tr>
                    <td colspan="5" class="py-16 text-center">
                        ...
                        <p class="text-slate-500 text-sm">La papelera está vacía.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
