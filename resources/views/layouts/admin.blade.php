...
<head>
    ...
    <title>@yield('title', 'Dashboard') — EduColegio Admin</title>
    <meta name="description" content="Panel de Administración - Sistema EduColegio">
    ...
    <div class="flex h-full min-h-screen">
        ...
        <aside id="sidebar"
            ...
            <div class="flex items-center gap-3 px-5 py-5 border-b border-slate-700/50 flex-shrink-0">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-sky-500 flex items-center justify-center text-lg shadow-lg shadow-indigo-500/30 flex-shrink-0">
                    🎓
                </div>
                <div>
                    <div class="text-sm font-bold bg-gradient-to-r from-indigo-400 to-sky-400 bg-clip-text text-transparent">
                        EduColegio
                    </div>
            ...
            <div class="border-t border-slate-700/50 p-4 flex-shrink-0">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-indigo-400">Administrador</div>
                    </div>
                ...
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">@yield('breadcrumb', 'Admin')</p>
                        </div>
                    </div>
